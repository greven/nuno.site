defmodule SiteWeb.FinderComponent do
  ...
  defp finder_search(assigns) do
    ...
    <div {@rest}>
      ...
      <input
        id={@id}
        class="w-full h-12 pl-11 px-4 py-2.5 rounded-control bg-transparent border-0 placeholder:text-content-40/80 text-content-10 sm:text-sm focus:outline-none focus:ring-0"
  ...
  defp finder_item(assigns) do
    ...
    <li
      id={@id}
      class={[
        "group cursor-default flex items-center justify-between rounded-control px-3 py-2 select-none",
