...
defmodule SiteWeb.Components.Theming do
  ...
  def button_cx(assigns) do
    %{color: color, variant: variant, size: size, wide: wide} = assigns
    ...
    %{
      root: [
        "relative isolate outline-none overflow-hidden cursor-pointer transition-all rounded-(--radius-control)",
