  ...
  def render(assigns) do
    ...
    <%= if @live_action == :about do %>
      <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div class="lg:pl-20">
          <ul role="list" class="flex flex-wrap gap-4 mb-8">
            <%!-- Email --%>
            <li>
            ...
            <li>
              <a href="https://github.com/greven" class="group btn-secondary">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="h-5 w-5 flex-none fill-secondary-900 transition group-hover:fill-primary-600"
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                ...
                <span class="transition group-hover:text-primary-600">Github</span>
              </a>
            </li>
            ...
            <li>
              <a href="https://twitter.com/grv_pt" class="group btn-secondary">
                ...
                <span class="transition group-hover:text-primary-600">Twitter</span>
              </a>
            </li>

            <%!-- Instagram --%>
            <li>
              <a href="https://www.instagram.com/i.am.nuno" class="group btn-secondary">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="h-5 w-5 flex-none fill-secondary-900 transition group-hover:fill-primary-600"
                ...
                <span class="transition group-hover:text-primary-600">Instagram</span>
              </a>
            </li>

            <%!-- Linkedin --%>
            <li>
              <a href="https://www.linkedin.com/in/nuno-fr3ire" class="group btn-secondary">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="h-5 w-5 flex-none fill-secondary-900 transition group-hover:fill-primary-600"
                ...
                <span class="transition group-hover:text-primary-600">Linkedin</span>
              </a>
            </li>
          </ul>
        </div>
