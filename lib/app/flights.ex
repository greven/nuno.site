defmodule App.Flights do
  ...
  @decorate cacheable(cache: App.Cache, key: {:visited_countries})
  ...
  @decorate cacheable(cache: App.Cache, key: {:visited_cities})
  ...
  @decorate cacheable(cache: App.Cache, key: {:flights})
  defp flights do
    flights_file()
    |> File.read!()
    |> Jason.decode!()
