defmodule AppWeb.AboutLive do
  ...
  def render(assigns) do
    ...
    <div class="flex gap-2 my-4">
      <.icon name="heroicons:academic-cap" class="w-8 h-8 text-base-content" />
      <.icon name="heroicons:academic-cap-solid" class="w-8 h-8 text-base-content" />
    </div>
          ...
          <li>
            <a href="https://github.com/greven" class="group btn-outline btn-sm border-2">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                class="h-5 w-5 flex-none fill-secondary-900 group-hover:fill-primary-600"
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
